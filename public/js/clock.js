...
- Need Button that will initiate the 48-hour countdown with an EventListener
- Need to have the countdown alert or flash when it gets to 0
...
- Need a way to take in the amount of time from user
  - I think we should be doing it by day and then have it function by having the clock count the date the user sets - Date.now
- Then need a way for the Timer to respond accordingly
- Might need a way for it to count functionality
- I wonder if there's a way to hard code that whatever date the person initializing chooses, it will alwaysset the end date to 11:59:59 PM
